import { Component, HostListener, OnInit, ChangeDetectorRef, OnDestroy, ViewChild, ViewEncapsulation } from '@angular/core';
...
// tslint:disable-next-line: deprecation
    ...
    resetPagination() {
        sessionStorage.setItem('acaciummovies-current-page', '1');
    }
